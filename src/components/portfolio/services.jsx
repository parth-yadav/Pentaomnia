  ...
  const services = [
    {
      ...
      description:
        "From conferences to team-building activities, we organize professional events that align with your business goals.",
    },
    {
      icon: (
        <svg
      ...
      description:
        "Create memorable moments with thoughtfully designed celebrations for all your important milestones.",
    },
    {
      icon: (
        <svg
